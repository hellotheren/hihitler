...
local IsRonix = ((identifyexecutor or (function() return "" end))():lower() == "ronixexploit" );
if IsRonix then
	print("Ronix")
end
...
local Library = {
    ...
    MainColor = Color3.fromRGB(15, 30, 60);             
    BackgroundColor = Color3.fromRGB(25, 50, 100);      
    AccentColor = Color3.fromRGB(65, 105, 225);        
    OutlineColor = Color3.fromRGB(5, 15, 40);
...
do
	...
	function Funcs:AddColorPicker(Idx, Info)
		...
		local CursorOuter = Library:Create('ImageLabel', {
			...
			BackgroundTransparency = 1;
			Image = 'http://www.roblox.com/asset/?id=512397953';
